...
var _AddTagName = _interopRequireDefault(__webpack_require__("nV3+"));
...
function useGetItems(formData, formViewerRef, layoutFormRef, showModal, onSave, layerRef, showViewerRef, formRenderedRef, linkageRef, domWrapperElRef, getInsertLocation) {
  ...
  var allTagNameRef = (0, _react.useRef)([]);
  var itemsRef = (0, _react.useRef)([{
    ...
    render: function render() {
      return _react.default.createElement("div", {
        ...
        onClick: function onClick() {
          _modal.default.confirm({
            title: "\u4E3A\u6240\u6709\u63A7\u4EF6\u6DFB\u52A0\u6807\u7B7E?",
            content: _react.default.createElement(_AddTagName.default, {
            ...
            onOk: function onOk() {
              ...
              groups.forEach(function (g) {
                var currentItems = g.groupRef.current.getFormItems();
                g.groupRef.current.setFormItems(currentItems.map(function (item) {
                  return _objectSpread({}, item, {
      ...
      }, "\u5168\u5C40\u6253\u6807\u7B7E"), _react.default.createElement(_button.default, {
        size: "small",
        type: "primary",
        icon: "block",
        className: "z-margin-right-12",
  ...
  return (0, _react.useRef)({
    colContentRender: function colContentRender(item, form) {
      ...
      return _react.default.createElement("div", {
        ...
        onClick: function onClick() {
          _modal.default.confirm({
            title: "\u4E3A [".concat(item.label, "] \u8FD9\u4E2A\u63A7\u4EF6\u6DFB\u52A0\u6807\u7B7E?"),
            content: _react.default.createElement(_AddTagName.default, {
              value: item.tagName,
              onChange: function onChange(val) {
...
function concatKeys(values, arr, a, d) {
  ...
  if (["6", "7", "8", "9"].includes(a.linkageType) || d.srcValue !== undefined && values[a.src.fieldKey] !== undefined && d.srcValue == values[a.src.fieldKey]) {
...
var initialValueLinkageAction = (0, _debounce.default)(function () {
  ...
  newFormObjs.forEach(function (o, i) {
    ...
    if (regionNameKeys.length) {
      ...
      regionNameKeys.forEach(function (field) {
        if (_formValues.hasOwnProperty(field.fieldKey)) {
          var info = values[field.srcFieldKey];

          if (_zTool.dataType.isObject(info) && field.regionName) {
    ...
    if (ocrParamNameKeys.length) {
      var _formValues2 = o.form.getFieldsValue();

      ocrParamNameKeys.forEach(function (field) {
        if (seftItem && seftItem.fieldKey !== field.srcFieldKey) return;

        if (_formValues2.hasOwnProperty(field.fieldKey)) {
          var info = Array.isArray(values[field.srcFieldKey]) ? values[field.srcFieldKey] : [];

          if (_zTool.dataType.isObject(info[0]) && field.ocrParamName) {
            var ocr = info[0].ocr || {};
            var regions = field.ocrParamName.split(",");
            var inputString = "";
            regions.forEach(function (key) {
              inputString += ocr[key];
            });
...
var dateKeys = ["format"];
var loadKey = ["url", "wxSourceTypes", "uploaderResponse", "autoUpload", "maxMegabytes"];
var uploadKeys = [].concat(loadKey, ["minUploadLength", "maxUploadLength", "fileAccept", "fileListType"]);
var prosAndConsKeys = [].concat(loadKey, ["ocrUrl", "ocrEnabled"]);
...
var controlWechat = [1, 2, 3, 4, 5, 6, 8, 9, 11, 13, 14, 15]; //日期格式在微信小程序组件库wux-weapp-ex支持情况
...
var controlList = [{
  ...
  label: "文件上传",
  value: 11,
  showKeys: [].concat(commonKeys, (0, _toConsumableArray2.default)(uploadKeys)),
  ...
  label: "电子签名",
  value: 15,
  showKeys: [].concat(commonKeys, ["isRequstSign", "getSignUrl", "setSignUrl"]),
  configKeys: ["isRequstSign", "getSignUrl", "setSignUrl"]
}, {
  label: "证件照(OCR)",
  value: 16,
  showKeys: [].concat(commonKeys, (0, _toConsumableArray2.default)(prosAndConsKeys)),
...
var getSwitchOpt = function getSwitchOpt() {
  ...
  var getProps = arguments.length > 1 ? arguments[1] : undefined;
  return {
    render: function render(form, changeFormItems) {
      return (0, _controls.getControl)("Switch", getProps && getProps(form, changeFormItems));
    },
...
function getKeyControl(keyDisabledRef, isUpdateRef, changeFormItems, form) {
  var inputOpt = {
    ...
    onBlur: function onBlur(e) {
      var fieldType = form.getFieldValue("fieldType");

      if (fieldType === 15 && !e.target.value.match(/Sign$/g)) {
        //电子签名的fieldKey自动添加Sign后缀
        form.setFieldsValue({
          fieldKey: "".concat(e.target.value, "Sign")
        });
      }
    }
  };
...
function useFormItems(groupId, formViewerRef, type) {
  ...
  _objectSpread({
    ...
    render: function render(form, changeFormItems) {
      return _react.default.createElement(_ZselectInput.default, {
        selectList: ["post"].map(function (m) {
          return {
            label: m,
            value: m
          };
  ...
  _objectSpread({
    ...
    options: (0, _controls.getOptions)({
      ...
      initialValue: {
        ocrUrlMethod: "post",
        ocrUrl: "/file-upload-service/webapi/v1.0/ocr/upload"
      },
    ...
    form: {
          ...
          try {
            ...
            if (config) {
              var objToArr = function objToArr(keyName) {
                if (_zTool.dataType.isObject(config[keyName])) {
              ...
              var extractConfig = function extractConfig(config, keys, targetKey) {
                var url = {};
      ...
      submitApiInterface: function submitApiInterface(values, props, tool) {
        ...
        if (values["fieldType"] === 15 && !values["fieldKey"].match(/Sign$/g)) {
          values["fieldKey"] = "".concat(values["fieldKey"], "Sign");
        }
        ...
        if (values.config) {
          if (formItem) {
            var prevConfig = typeof formItem.config === "string" ? JSON.parse(formItem.config) : formItem.config;
            values.config = _objectSpread({}, prevConfig, {}, values.config);
          }
...
function ValueLinkControl(props) {
  ...
  var ocrFieldNameRef = (0, _react.useRef)("name");
  (0, _react.useEffect)(function () {
    switch (linkageType) {
      case "1":
      case "2":
      ...
      case "9":
        setLeftTransferSelections(turnSelectOptions(newFormData.sectionList, true, function (list) {
          return list.filter(function (item) {
            return [16].includes(item.fieldType);
          });
        }));
        setRightTransferSelections(turnSelectOptions(newFormData.sectionList, true, function (list) {
          return list.filter(function (item) {
  ...
  var selectParamname = {
    8: {
      remark: (0, _linkRemark.linkRemark4)(linkValue, {
        remmak1: "选项的行政区划信息传入：",
        remmak2: "的内容是："
      }),
    ...
    9: {
      ...
      selectList: _common.ocrFieldNames
    }
  };
  return _react.default.createElement(_row.default, {
    ...
    onChange: function onChange(actionType, rightData, actionItem, sibligItem) {
      setLinkValue(["6", "7", "8", "9"].includes(linkageType) ? _objectSpread({}, linkValue, {
  ...
  })) : null, ["8", "9"].includes(linkageType) ? _react.default.createElement("div", {
    className: "z-linkage-remark"
  }, _react.default.createElement("div", {
    className: "z-margin-bottom-12"
  }, selectParamname[linkageType].remark), (0, _controls.getControl)("Select", {
    style: {
      width: "240px"
    },
...
var MyUpload = _react.default.forwardRef(function (props, ref) {
  ...
  var uploadAsync = function uploadAsync() {
    ...
    if (config.url) (0, _httpAjax.default)(config.urlMethod ? config.urlMethod : "post", "".concat(config.url, "?").concat(config.userIdName ? config.userIdName : "userId", "=").concat(userId), formData).then(function (re) {
  ...
  var uploadButtonName = buttonName ? buttonName : isOnlyPicture ? "选择图片" : "选择文件"; //选文件按钮
...
var ZprosAndCons = _react.default.memo(function (props) {
  var value = props.value,
      _onChange = props.onChange,
      config = props.config,
      field = props.field,
  ...
  return _react.default.createElement("div", {
    ...
    onChange: function onChange(val, uploadFiles) {
      if (val.length && uploadFiles && uploadFiles.length) {
        var picData = val[0] || null;
        var ocrUrl = config.ocrUrl,
            ocrUrlMethod = config.ocrUrlMethod,
        ...
        if ((ocrEnabled === undefined || ocrEnabled) && ocrUrl) {
          ...
          return (0, _httpAjax.default)(ocrUrlMethod, ocrUrl, formData).then(function (res) {
            _message2.default.success("证件识别成功。");

            currentValue[0] = picData;
            picData["ocr"] = res.data;
            _onChange && _onChange((0, _toConsumableArray2.default)(currentValue));
          });
        } else {
          currentValue[0] = picData;
          _onChange && _onChange((0, _toConsumableArray2.default)(currentValue));
...
var _default = _ZerodMainContext.default.setConsumer(_ZerodLayerContext.default.setConsumer(ZprosAndCons));
...
var geocoder = {
  amap: function amap(location, webserviceUrlDO) {
    ...
    var amaporigin = process && Object({"NODE_ENV":"production"}) && Object({"NODE_ENV":"production"}).amap ? Object({"NODE_ENV":"production"}).amap : 'https://restapi.amap.com';
    return getWebService(webserviceUrlDO, {
      serviceApi: "".concat(amaporigin, "/v3/geocode/regeo"),
      query: {
  ...
  qqmap: function qqmap(location, webserviceUrlDO) {
    var qqmaporigin = process && Object({"NODE_ENV":"production"}) && Object({"NODE_ENV":"production"}).qqmap ? Object({"NODE_ENV":"production"}).qqmap : 'https://apis.map.qq.com';
    return getWebService(webserviceUrlDO, {
      serviceApi: "".concat(qqmaporigin, "/ws/geocoder/v1"),
      query: {
          ...
          geocoder[thisType](val, webserviceUrlDO).then(function (res) {
            ...
            if (thisType === "amap") {
              ...
              area = {
                ...
                pointWkt: "POINT(".concat(val.longitude, " ").concat(val.latitude, ")"),
                pointWkt2000: ""
              };
    ...
    loadData: selectionsUrl && selectionsUrl.requireType === "part" ? function (selectedOptions) {
      ...
      (0, _zTool.httpAjax)(selectionsUrl.selectionsUrlMethod, selectionsUrl.selectionsUrl, _objectSpread({}, selectionsQuery, {
        ...
        if (Array.isArray(re.data) && re.data.length) {
          targetOption.children = (0, _common.treeDataAddKey)(re.data, undefined, selectListFieldNames, false);
        } else {
...
var _ZprosAndCons = _interopRequireDefault(__webpack_require__("RYZL"));
  ...
  return function () {
    ...
    if (selectionsType == 2 && !hasAsync && !noAsync) {
      ...
      return (0, _zTool.httpAjax)(selectionsUrl.selectionsUrlMethod, selectionsUrl.selectionsUrl, _objectSpread({}, selectionsQuery, {}, requestQuery)).then(function (re) {
        return getCurrentControl((0, _common.treeDataAddKey)(re.data, undefined, selectListFieldNames, undefined));
      }).catch(function () {
        if (currentForm) {
    ...
    return getCurrentControl((0, _common.treeDataAddKey)(selectList, undefined, selectListFieldNames, undefined));
  };
}
...
var controls = {
  ...
  6: {
    getControl: function getControl() {
      ...
      if (selectionsType == 2 && !hasAsync && !noAsync) {
        ...
        return (0, _zTool.httpAjax)(selectionsUrl.selectionsUrlMethod, selectionsUrl.selectionsUrl, _objectSpread({}, selectionsQuery, {}, requestQuery)).then(function (re) {
          return getCurrentControl((0, _common.treeDataAddKey)(re.data, undefined, selectListFieldNames, selectionsUrl.requireType !== "part" // false  即为分部加载
          ));
        }).catch(function () {
          if (currentForm) {
            currentForm.saveFieldOptions[e.fieldKey] = [];
      ...
      return getCurrentControl((0, _common.treeDataAddKey)(selectList, undefined, selectListFieldNames, true));
    },
    getOptions: getOptionsRules
  },
  //TreeSelect树选择
  7: {
    getControl: function getControl() {
      ...
      if (selectionsType == 2 && !hasAsync && !noAsync) {
        ...
        return (0, _zTool.httpAjax)(selectionsUrl.selectionsUrlMethod, selectionsUrl.selectionsUrl, _objectSpread({}, selectionsQuery, {}, requestQuery)).then(function (re) {
          return getCurrentControl((0, _common.treeDataAddKey)(re.data, {
            label: "title",
            value: "value",
            children: "children",
            key: "key"
      ...
      return getCurrentControl((0, _common.treeDataAddKey)(selectList, {
        label: "title",
        value: "value",
        children: "children",
        key: "key"
  ...
  16: {
    getControl: function getControl() {
      ...
      config = _objectSpread({}, defaultFieldConfig, {}, config);
      return _react.default.createElement(_ZprosAndCons.default, {
        config: config,
        field: e,
        onChange: function onChange() {
          (0, _linkageAction.default)(linkages, getGroupsFn, e);
...
function LinkageConfig(props) {
  ...
  var defaultLinkagesRef = (0, _react.useRef)(defaultValue); // console.log("defaultValue", defaultValue);
  ...
  var onRemove = function onRemove(currentConf, srcIndex, distIndex) {
    _modal.default.confirm({
      title: "是否确认移除这条配置?",
      okText: "确定",
      cancelText: "取消",
      onOk: function onOk() {
        ...
        if (ageIndex > -1) {
          if (["6", "7", "8", "9"].includes(currentLinkageType)) {
            ...
            currentConfigured.splice(srcIndex, 1);
            defaultLinkagesRef.current[ageIndex].dist = (0, _toConsumableArray2.default)(currentConfigured);
          ...
          var newConfigured = (0, _toConsumableArray2.default)(currentConfigured);
  ...
  return _react.default.createElement("section", {
    ...
    onOk: function onOk(links, other) {
      ...
      if (["1", "2", "3", "5.2"].includes(curentLinkTypeRef.current.key)) {
        age.dist = links.srcValues.map(function (val) {
        ...
        var ocrParamName = curentLinkTypeRef.current.key === "9" ? other.ocrParamName : undefined;
        linkages = links.srcControls.map(function (l) {
          var fields = links.distControls.map(function (d) {
            return {
              ...
              ocrParamName: ocrParamName
            };
          });
          return _objectSpread({}, age, {
            src: {
              fieldKey: l.fieldKey,
              label: l.label,
      ...
      if (Array.isArray(age.dist) && age.dist.length) {
        ...
        age.dist = (0, _toConsumableArray2.default)(currentConfigured);
        configuredRef.current.setConfigured((0, _toConsumableArray2.default)(currentConfigured)); //新的linkages

        var existLinkageIndex = -1;

        if (Array.isArray(defaultLinkagesRef.current)) {
          existLinkageIndex = defaultLinkagesRef.current.findIndex(function (item) {
            return age.linkageType === item.linkageType && age.src.fieldKey === item.src.fieldKey;
          });
        }
      ...
      if (Array.isArray(linkages) && linkages.length && Array.isArray(defaultLinkagesRef.current)) {
        linkages.forEach(function (age) {
          var hasAgeIndex = defaultLinkagesRef.current.findIndex(function (item) {
            return age.linkageType === item.linkageType && age.src.fieldKey === item.src.fieldKey;
          });

          if (hasAgeIndex > -1) {
            var hasAge = defaultLinkagesRef.current[hasAgeIndex];
            var currageKeysConcat = "";
            var currAgeDist = age.dist[0];
            currAgeDist.fields.forEach(function (f) {
              currageKeysConcat += f.fieldKey;
            });
            currageKeysConcat += "".concat(currAgeDist.asyncParamName).concat(currAgeDist.regionName).concat(currAgeDist.ocrParamName);
            var fieldsIndex = hasAge.dist.findIndex(function (item) {
              var keysConcat = "";
              item.fields.forEach(function (f) {
                keysConcat += f.fieldKey;
              });
              keysConcat += "".concat(item.asyncParamName).concat(item.regionName).concat(item.ocrParamName);
        ...
        var IDconfigured = defaultLinkagesRef.current.filter(function (item) {
      ...
      defaultLinkagesRef.current = (0, _toConsumableArray2.default)(defaultLinkagesRef.current);
      onChange && onChange(defaultLinkagesRef.current); // console.log("联动配置", age, linkages, defaultLinkagesRef.current);
    },
  ...
  }, ["6", "7", "8", "9"].includes(curentLinkTypeRef.current.key) ? _react.default.createElement(_IDLinkagesConfigured.default, {
    ref: configuredRef,
    onRemove: onRemove
...
var _ZlabelInput = _interopRequireDefault(__webpack_require__("qcaH"));
...
var colors = ["#F8AD3A", "#01D0A2", "#3277FA", "#B94354", "#7469F1"];

var AddTagName = _react.default.memo(_react.default.forwardRef(function (props, ref) {
  var value = props.value,
      onChange = props.onChange;
  ...
  (0, _react.useEffect)(function () {
    if (Array.isArray(value)) {
      var newTags = [].concat(defaultTags);
      value.forEach(function (item) {
        var finded = newTags.find(function (f) {
      ...
      setTags(newTags);
      setTagValue(value.map(function (item) {
        return item.value;
      }));
    }
  }, [value]);
  ...
  }, (0, _controls.getControl)("Checkbox.Group", {
    layout: "vertical",
    value: tagValue,
    optLabelRender: function optLabelRender(item, index) {
      return _react.default.createElement(_tag.default, {
        style: {
          cursor: "pointer"
        },
  ...
  }, "\u81EA\u52A0\u6807\u7B7E"), _react.default.createElement(CustomTagName, {
    onOk: function onOk(newVal) {
      var finded = tags.findIndex(function (item) {
      ...
      if (finded > -1) {
        ...
        setTags([].concat((0, _toConsumableArray2.default)(tags), [newVal]));
      }
    }
  })));
}));

var CustomTagName = _react.default.memo(function NameEdit(props) {
  var onOk = props.onOk;
  ...
  return _react.default.createElement("div", {
    ...
    className: "z-flex-1"
  }, _react.default.createElement(_ZlabelInput.default, {
      ...
      return (0, _zTool.httpAjax)(selectionsUrl.selectionsUrlMethod, selectionsUrl.selectionsUrl, _objectSpread({}, selectionsQuery, {
        ...
        (0, _zTool.itemsFromTree)({
          ...
          action: function action(_ref) {
            ...
            if (Array.isArray(re.data) && re.data.length) {
              currentItem.children = (0, _common.treeDataAddKey)(re.data, {
                label: "title",
                value: "value",
                children: "children",
                key: "key"
...
exports.treeDataAddKey = treeDataAddKey;
exports.ocrFieldNames = exports.regionNames = void 0;
...
exports.ocrFieldNames = ocrFieldNames;
...
function getFormItem(_ref) {
  ...
  var newField = _objectSpread({}, field, {
    ...
    tagName: Array.isArray(field.tagName) && field.tagName.length ? field.tagName : Array.isArray(config.tagName) ? config.tagName : [],
...
function treeDataAddKey() {
  ...
  return Array.isArray(tree) ? tree.map(function (item) {
    ...
    return _ref3 = {}, (0, _defineProperty2.default)(_ref3, distKey.label, item[srcKey.label]), (0, _defineProperty2.default)(_ref3, distKey.value, item[srcKey.value]), (0, _defineProperty2.default)(_ref3, distKey.children, ciilds.length ? ciilds : null), (0, _defineProperty2.default)(_ref3, distKey.key, item[srcKey.value]), (0, _defineProperty2.default)(_ref3, "isLeaf", isLeaf), _ref3;
  }) : [];
}
...
function IDLinkagesConfigured(props, ref) {
  ...
  return _react.default.createElement(_react.default.Fragment, null, configured.map(function (c, index) {
    return _react.default.createElement(_row.default, {
      ...
      span: 18
    }, c.dist.map(function (d, distIndex) {
      var key = "";
      d.fields.forEach(function (f) {
        key += f.fieldKey;
      });
      key += "".concat(d.asyncParamName).concat(d.regionName).concat(d.ocrParamName);
      return _react.default.createElement("div", {
        key: key,
        className: "z-margin-bottom-10 z-flex"
      }, _react.default.createElement("div", {
        className: "z-flex-1"
      }, _react.default.createElement("span", null, c.linkageType === "6" ? "出生年月日接收控件：" : "联动控件："), _react.default.createElement("span", null, d.fields.map(function (item) {
        return _react.default.createElement(_tag.default, {
          color: "magenta",
          key: item.fieldKey
        }, item.label);
      })), d.asyncParamName ? _react.default.createElement("span", null, "\u8BF7\u6C42\u9009\u9879\uFF0C\u5176\u53C2\u6570\u540D\uFF1A", _react.default.createElement(_tag.default, {
        color: "red"
      }, d.asyncParamName)) : null, d.regionName ? _react.default.createElement("span", null, "\u5185\u5BB9\u662F\uFF1A", _react.default.createElement(_tag.default, {
        color: "red"
      }, _common.regionNames.find(function (item) {
        return item.value === d.regionName;
      }).label)) : null, d.ocrParamName ? _react.default.createElement("span", null, "\u5185\u5BB9\u662F\uFF1A", _react.default.createElement(_tag.default, {
        color: "red"
      }, _common.ocrFieldNames.find(function (item) {
        return item.value === d.ocrParamName;
