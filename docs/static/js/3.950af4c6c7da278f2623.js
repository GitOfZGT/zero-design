...
var pageConfig = {
  ...
  footerLinks: null,
  routerType: publiced.path == "/" ? "history" : "hash" // routerType:"hash",
...
console.log(_react.default.version); // console.log("这个[1925]撒大苏打[对方的]十大高手[99999]555[".match(/(?<=.*)\[[\w\u4e00-\u9fa5]*\]/g))
...
var _default = {
  ...
  menuData: [{
    ...
    iconClass: "tags",
    children: [{
      permUrl: "ZListMasonry-doc",
      permName: "堆砌列表 : ZListMasonry",
      iconClass: ""
    }, {
...
_mockjs.default.mock("/webapi/v1.0/config/center/pageServiceInfo", "post", function (opt) {
  ...
  if (query.currPage > body.data.totalPage) {
    ...
    var listdata = _mockjs.default.mock(body);
...
//# sourceMappingURL=3.950af4c6c7da278f2623.js.map