                    ...
                    this.config.form
                        ...
                        .then((re) => {
                            ...
                            this.setState(
                                ...
                                () => {
                                    if (Object.keys(valueData).length && this.formMethods)
                                        this.formMethods.setFieldsValue(valueData);
                                },
                            );
                        })
                        // .catch((re) => {
                ...
                return {
                    ...
                    render:
                        typeof item.render == 'function'
                            ? (form, changeFormItems) => {
                                  return item.render(form, changeFormItems, this.tool);
                              }
                            : () => <Input disabled placeholder="缺少render函数"></Input>,
                };
            });
        };
